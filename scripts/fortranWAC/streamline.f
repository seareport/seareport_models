...
!     &                 -(Y(I3)-Y(I2))*(XP-X(I2)))*SURDET(IEL)
        XD1 = X(I3)-X(I2)
        IF( XD1.GT. 180.D0 ) THEN
          XD1 = XD1 - 360.D0
        ELSEIF( XD1.LT. -180.D0 ) THEN
          XD1 = XD1 + 360.D0
        ENDIF
        XD2 = XP   -X(I2)
        IF( XD2.GT. 180.D0 ) THEN
          XD2 = XD2 - 360.D0
        ELSEIF( XD2.LT. -180.D0 ) THEN
          XD2 = XD2 + 360.D0
        ENDIF
        SHP(1,IPLOT) = ((XD1)*(YP-Y(I2))
     &                 -(Y(I3)-Y(I2))*(XD2))*SURDET(IEL)
!        SHP(2,IPLOT) = ((X(I1)-X(I3))*(YP-Y(I3))
!     &                 -(Y(I1)-Y(I3))*(XP-X(I3)))*SURDET(IEL)
        XD1 = X(I1)-X(I3)
        IF( XD1.GT. 180.D0 ) THEN
        ...
        ELSEIF( XD2.LT. -180.D0 ) THEN
          XD2 = XD2 + 360.D0
        ENDIF
        SHP(2,IPLOT) = ((XD1)*(YP-Y(I3))
     &                 -(Y(I1)-Y(I3))*(XD2))*SURDET(IEL)
!        SHP(3,IPLOT) = ((X(I2)-X(I1))*(YP-Y(I1))
!     &                 -(Y(I2)-Y(I1))*(XP-X(I1)))*SURDET(IEL)
        XD1 = X(I2)-X(I1)
        IF( XD1.GT. 180.D0 ) THEN
        ...
        ELSEIF( XD2.LT. -180.D0 ) THEN
          XD2 = XD2 + 360.D0
        ENDIF
        SHP(3,IPLOT) = ((XD1)*(YP-Y(I1))
     &                 -(Y(I2)-Y(I1))*(XD2))*SURDET(IEL)
!###< SEB @ EDF
!
        SHZ(IPLOT) = (ZP-ZSTAR(IET)) / (ZSTAR(IET+1)-ZSTAR(IET))
!       ASSUME ALL ARE LOCALISED, IT WILL BE SET OTHERWISE IF LOST-AGAIN
...
!
            ...
            DX1 = X(I2) - X(I1)
!###> SEB @ EDF : THE EARTH BY TELEMAC
            IF( DX1.GT. 180.D0 ) THEN
              DX1 = DX1 - 360.D0
            ELSEIF( DX1.LT. -180.D0 ) THEN
              DX1 = DX1 + 360.D0
            ENDIF
!###< SEB @ EDF
            DY1 = Y(I2) - Y(I1)
