...
!
!history  S.E.BOURBAN (EDF R&D), M.S.TURNBULL (HRW), T.SAILLOUR (SPERI)
!+        November 2021
!+        V8P2
!+   Corrections made to SCHAR41_PER for the Earth by TELEMAC,
!+   to allow periodical coordinates [-180;180]
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!###> SEB @ EDF : THE EARTH BY TELEMAC
      DOUBLE PRECISION XD1,XD2,R
      PARAMETER R = 6370000.D0
!###< SEB @ EDF
!
!-----------------------------------------------------------------------
...
399     FORMAT(1X,'INBIEF (BIEF) : ELEMENT NOT IMPLEMENTED WITH',/,1X,
     &            'MERCATOR PROJECTION:',1I3)
      ...
      ENDIF
!
!###> SEB @ EDF : THE EARTH BY TELEMAC - COMMENTED OUT
!      IF(SPHERI) THEN
!
...
!###> SEB @ EDF : THE EARTH BY TELEMAC
            IF( X2.GT. 180.D0 ) THEN
              X2 = X2 - 360.D0
            ELSEIF( X2.LT. -180.D0 ) THEN
              X2 = X2 + 360.D0
            ENDIF
!###< SEB @ EDF
            X3 = - MESH%X%R(I1) + MESH%X%R(I3)
!###> SEB @ EDF : THE EARTH BY TELEMAC
            IF( X3.GT. 180.D0 ) THEN
              X3 = X3 - 360.D0
            ELSEIF( X3.LT. -180.D0 ) THEN
              X3 = X3 + 360.D0
            ENDIF
!###< SEB @ EDF
